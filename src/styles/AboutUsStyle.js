export const AboutUsStyles = {
  ...
  cardName: 'inline-flex items-center justify-center gap-2 text-lg font-bold mb-2',
  ...
  `,
  linkedinIcon: 'ml-2', // Added class for margin between name and LinkedIn icon
  linkedinImage: 'w-5 h-5 inline-block align-middle', // Styling for LinkedIn image
};
